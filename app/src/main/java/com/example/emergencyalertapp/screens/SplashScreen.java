...
public class SplashScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(isServicesOK()){
            new Handler().postDelayed(this::checkInternetConectivity, 1300);
        }
    }
    ...
    private void checkInternetConectivity() {
        if (CheckNetworkConnectivity.getInstance(this).isOnline()) {
            ...
            Snackbar.make(findViewById(R.id.rootLayout), "No internet connectivity, some feature will not work properly", Snackbar.LENGTH_INDEFINITE)
                    .setAction("OK", v -> {startApp();})
                    .show();
        }
    }
